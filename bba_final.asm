...
erro_tec   db   'Invalid Command. Check the command list and its codes.', '$'
erro_arq   db   'Error opening file. Check if the name was correctly typed.', '$'
erro_lin   db   027H,'Row',027h,' accepts only numbers between 0 and 7. Try again.', '$'
erro_col   db   027H,'Column',027h,' accepts only numbers between 0 and 7. Try again.', '$'
erro_col_1 db   'The selected row allows only shoots in columns 0 or 7.', '$'
erro_dir   db   027H,'Direction',027h,' is the direction of the ray entering the box. Accepts E,B,C,D.', '$'
erro_dir_2 db   'The selected direction is not valid for these coordinates.', '$'
saiu_m	   db   'The ray left the box in ', '$'
refletido_m db  'The ray was deflected. It entered in ', '$'
absorvido_m db  'The ray was absorbed. It entered in ', '$'
marquivo   db   'Input the name of the scenario file: ','$' 
nome	   db    15 dup (?), '$'
erro_enc2  db   'The game has ended. Finish the program (F) or start a new game (N).', '$'
pont_certo db   'Aced it! Congratulations! Final Score: ', '$'
pont_erro  db   'Error setting some atoms! Final Score: ', '$'
erro_enc   db   'There has been no try. There are no results to show.', '$'
erro_escm  db   'It is not possible to return from this field. ','$'
var1       db    0
var2	   db    0
linha	   db    0
coluna     db    0
